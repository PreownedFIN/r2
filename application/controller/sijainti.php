 ...
 *
 */
class Sijainti extends Controller
{
    /**
     * PAGE: index
    ...
    {
		echo "olet sijainticontrollerin index-funktiossa";
    }
    ...
    {
		// tarkistetaan ensin, että tänne saapui kaikki tarvittavat parametrit (msg -viesti ei ole pakollinen)
		if(isset($_POST["uid"]) && 
			isset($_POST["gid"]) &&
			isset($_POST["lat"]) &&
			isset($_POST["lng"])) {

			$s_model = $this->lataaModel('sijaintimodel');
			$vastaus = $s_model->lisaa($_POST["uid"], 
							$_POST["gid"],
							$_POST["lat"],
							$_POST["lng"],
							$_POST["msg"]);
